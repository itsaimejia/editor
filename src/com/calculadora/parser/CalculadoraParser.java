...
public class CalculadoraParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, NL=4, MULT=5, DIV=6, SUM=7, SUB=8, INT=9, ID=10, 
		WS=11;
	public static final int
		RULE_program = 0, RULE_instructions = 1, RULE_expr = 2;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "instructions", "expr"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, "NL", "MULT", "DIV", "SUM", "SUB", "INT", "ID", 
			"WS"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__1) | (1L << NL) | (1L << INT) | (1L << ID))) != 0) );
			}
		}
	...
	public static class AsignacionContext extends InstructionsContext {
		...
		public TerminalNode NL() { return getToken(CalculadoraParser.NL, 0); }
	...
	public static class VacioContext extends InstructionsContext {
		public TerminalNode NL() { return getToken(CalculadoraParser.NL, 0); }
		public VacioContext(InstructionsContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class SumSubContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculadoraVisitor ) return ((CalculadoraVisitor<? extends T>)visitor).visitSumSub(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\2\2\2\13\t\3\2\2\2\13\f\3\2\2\2\f\3\3\2\2\2\r\16\5\6\4\2\16\17\7\6\2"+
		"\2\17\27\3\2\2\2\20\21\7\f\2\2\21\22\7\3\2\2\22\23\5\6\4\2\23\24\7\6\2"+
		"\2\24\27\3\2\2\2\25\27\7\6\2\2\26\r\3\2\2\2\26\20\3\2\2\2\26\25\3\2\2"+
		"\2\27\5\3\2\2\2\30\31\b\4\1\2\31 \7\13\2\2\32 \7\f\2\2\33\34\7\4\2\2\34"+
