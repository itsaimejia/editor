...
import sample.CustomOutputStream;
...
public class JavaKeywordsDemo extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        MenuItem item_clean = new MenuItem("Clean up");
        ...
        menuTools.getItems().add(item_clean);
        menuTools.getItems().add(item_exit);

        Menu menuTranslate = new Menu("Translate");
        MenuItem item_translate = new MenuItem("Translate to Opmez");
        item_translate.setOnAction(actionEvent -> {
            text_Output.clear();
            if (creado){
                try {
                    saveFile();
        ...
        menuTranslate.getItems().add(item_translate);
